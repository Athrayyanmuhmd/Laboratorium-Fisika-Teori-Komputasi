...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <a href="{{ route('admin.equipment.index') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold mb-2">Kelola Peralatan</h3>
                    <p class="text-blue-100">{{ $totalEquipment }} peralatan terdaftar</p>
                </div>
                <i class="fas fa-cogs text-3xl opacity-75"></i>
            </div>
        </a>

        <a href="{{ route('admin.computers.index') }}" class="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold mb-2">Kelola Komputer</h3>
                    <p class="text-purple-100">{{ $labStats['total_computers'] }} unit komputer</p>
                </div>
                <i class="fas fa-desktop text-3xl opacity-75"></i>
            </div>
        </a>

        <a href="{{ route('admin.simulations.index') }}" class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold mb-2">Kelola Simulasi</h3>
                    <p class="text-green-100">{{ $pendingRentals }} permintaan pending</p>
                </div>
                <i class="fas fa-calculator text-3xl opacity-75"></i>
            </div>
        </a>

        <a href="{{ route('admin.consultations.index') }}" class="bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold mb-2">Kelola Konsultasi</h3>
                    <p class="text-orange-100">{{ $pendingTests }} konsultasi pending</p>
                </div>
                <i class="fas fa-comments text-3xl opacity-75"></i>
            </div>
        </a>
    </div>

    <!-- New Services Section -->
    <div class="bg-white rounded-2xl shadow-lg p-8 card-hover border border-gray-100 mb-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Layanan Laboratorium Fisika Teori dan Komputasi</h2>
                <p class="text-gray-600">Kelola layanan penyewaan workstation, kunjungan lab, dan analisis data</p>
            </div>
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-lg">
                <div class="text-sm">Total Layanan</div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border border-blue-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="bg-blue-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                        {{ $totalWorkstationRentals ?? 0 }} Total
                    </span>
                </div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">Penyewaan Workstation</h3>
                <p class="text-gray-600 text-sm mb-4">Akses ke 28 PC workstation canggih untuk komputasi, simulasi, dan pengembangan software</p>
                
                <div class="space-y-2 mb-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Menunggu:</span>
                        <span class="font-semibold text-yellow-600">{{ $pendingWorkstationRentals ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Disetujui:</span>
                        <span class="font-semibold text-green-600">{{ $approvedWorkstationRentals ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Selesai:</span>
                        <span class="font-semibold text-blue-600">{{ $completedWorkstationRentals ?? 0 }}</span>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-4">
                    <div>✓ PC High-Performance</div>
                    <div>✓ Software Geofisika</div>
                    <div>✓ Tools Fotografi</div>
                    <div>✓ Environment Programming</div>
                </div>
                
                <a href="{{ route('admin.workstations.index') }}" class="w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors text-center block">
                    <i class="fas fa-cog mr-2"></i>Kelola Permintaan
                </a>
            </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                        {{ $totalLabVisits ?? 0 }} Total
                    </span>
                </div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">Kunjungan Laboratorium</h3>
                <p class="text-gray-600 text-sm mb-4">Program edukasi dan eksplorasi fasilitas lab untuk mendukung pembelajaran fisika komputasi</p>
                
                <div class="space-y-2 mb-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Menunggu:</span>
                        <span class="font-semibold text-yellow-600">{{ $pendingLabVisits ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Disetujui:</span>
                        <span class="font-semibold text-green-600">{{ $approvedLabVisits ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Selesai:</span>
                        <span class="font-semibold text-blue-600">{{ $completedLabVisits ?? 0 }}</span>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-4">
                    <div>✓ Tur Fasilitas</div>
                    <div>✓ Workshop Simulasi</div>
                    <div>✓ Demo Software</div>
                    <div>✓ Konsultasi Ahli</div>
                </div>
                
                <a href="{{ route('admin.lab-visits.index') }}" class="w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 transition-colors text-center block">
                    <i class="fas fa-calendar-alt mr-2"></i>Kelola Kunjungan
                </a>
            </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-6 border border-purple-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="bg-purple-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
                        {{ $totalAnalysisRequests ?? 0 }} Total
                    </span>
                </div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">Analisis & Simulasi Data</h3>
                <p class="text-gray-600 text-sm mb-4">Layanan pengolahan data dan simulasi menggunakan computational physics dan software geofisika</p>
                
                <div class="space-y-2 mb-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Menunggu:</span>
                        <span class="font-semibold text-yellow-600">{{ $pendingAnalysisRequests ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Diproses:</span>
                        <span class="font-semibold text-orange-600">{{ $inProgressAnalysisRequests ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Selesai:</span>
                        <span class="font-semibold text-blue-600">{{ $completedAnalysisRequests ?? 0 }}</span>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-4">
                    <div>✓ Simulasi Numerik</div>
                    <div>✓ Analisis Geofisika</div>
                    <div>✓ Visualisasi Data</div>
                    <div>✓ Laporan Komprehensif</div>
                </div>
                
                <a href="{{ route('admin.analysis-requests.index') }}" class="w-full bg-purple-500 text-white py-2 px-4 rounded-lg hover:bg-purple-600 transition-colors text-center block">
                    <i class="fas fa-microscope mr-2"></i>Kelola Analisis
                </a>
            </div>
        </div>
    </div>
